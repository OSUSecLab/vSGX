Intel(R) Software Guard Extensions for Linux\* OS Modified for vSGX
================================================

# vSGX Modification

We hardcoded EPC information into `sgx_main.c`. See [COMPATIBILITY.md](../COMPATIBILITY.md) for more details.
